class EmergenciesController < ApplicationController
  ...
  private
    ...
    def emergency_params
      params.require(:emergency).permit(:lugar, :denunciante, :telefono_denunciante, :numero_caso, :sigla_vehiculo, :hora_salida, :observacion, :referencia_lugar, :tipo, :user_id)
    end
end
