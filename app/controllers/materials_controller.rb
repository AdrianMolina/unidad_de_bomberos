class MaterialsController < ApplicationController
  ...
  def destroy
    @material.destroy
    respond_to do |format|
      format.html { redirect_to materials_url, notice: 'Material borrado con exito' }
  ...
  private
    ...
    def material_params
      params.require(:material).permit(:especialidad, :codigo, :estado, :ubicacion, :nombre_material)
    end
end
