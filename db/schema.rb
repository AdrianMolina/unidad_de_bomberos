...
ActiveRecord::Schema.define(version: 20150129214858) do
  ...
  add_index "androids", ["vehicle_id"], name: "index_androids_on_vehicle_id"
  ...
  create_table "assist_pre_hospitals", force: true do |t|
    t.integer  "user_id"
    t.integer  "pre_hospital_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "assist_pre_hospitals", ["pre_hospital_id"], name: "index_assist_pre_hospitals_on_pre_hospital_id"
  add_index "assist_pre_hospitals", ["user_id"], name: "index_assist_pre_hospitals_on_user_id"
  ...
  create_table "fire_material_useds", force: true do |t|
    t.integer  "material_id"
    t.integer  "fire_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "fire_material_useds", ["fire_id"], name: "index_fire_material_useds_on_fire_id"
  add_index "fire_material_useds", ["material_id"], name: "index_fire_material_useds_on_material_id"
  ...
  create_table "institution_lists", force: true do |t|
    t.string   "sigla"
    t.string   "nombre"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "pre_hospitals", force: true do |t|
    t.string   "numero_caso"
    t.time     "hora_incidente"
  ...
  add_index "pre_hospitals", ["emergency_id"], name: "index_pre_hospitals_on_emergency_id"
  ...
  create_table "rescue_material_useds", force: true do |t|
    t.integer  "rescue_id"
    t.integer  "material_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "rescue_material_useds", ["material_id"], name: "index_rescue_material_useds_on_material_id"
  add_index "rescue_material_useds", ["rescue_id"], name: "index_rescue_material_useds_on_rescue_id"
  ...
  add_index "vehicles", ["android_id"], name: "index_vehicles_on_android_id"
